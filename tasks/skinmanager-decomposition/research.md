...
### Section 1a: SkinArchivePayload (lines 10-14) — 5 lines
...
### Section 1b: SkinArchiveLoader (lines 16-80) — 65 lines
...
### Section 1c: SkinImportError (lines 82-103) — 22 lines
...
### Section 2: State & Initialization (lines 108-147) — 40 lines
...
### Section 3: Default Skin Full Parse (lines 149-204) — 56 lines
...
### Section 4: Skin Discovery (lines 210-260) — 51 lines
...
### Section 5: Skin Switching & Initial Load (lines 262-301) — 40 lines
...
### Section 6: Skin Import (lines 303-466) — 164 lines
...
### Section 7: Background Preprocessing (lines 468-516) — 49 lines
...
### Section 8: Fallback Sprite Generation (lines 518-594) — 77 lines
