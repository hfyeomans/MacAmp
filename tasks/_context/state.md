...
| S3-2 (pivot) | sequential | `done/avplayer-native-video-dsp` | `feat/avplayer-native-video-dsp` | **#89** | S3-1 merged ✅ + Phase 1 cherry-pick ✅ | `spike/avplayer-inplace-tap-dsp` ✅ done (preserved on `origin` 2026-09-26 at the user's request (`dd53d64`, not in `main`); evaluate later whether it can be deleted) | ✅ **MERGED** 2026-09-25 (merge `ae15f5c`) — [PR #89](https://github.com/hfyeomans/MacAmp/pull/89), 96 commits. Steps 1-3 ✅; **Phases 1-7 ✅** Oracle-approved; **Phase 8 ✅ COMPLETE 2026-09-25** (all manual gates run with the user; 8.1b PARTIAL, 8.2/8.11/8.12 NOT ABLE, 8.8 N/A, rest PASS — `tasks/done/avplayer-native-video-dsp/verification.md`; 119 TSan tests, only pre-existing #86 fails); **Phase 9 ✅ 2026-09-25**. See `_context/s3-2-pivot.md` (RESOLVED). |
...
**S3-2 pending items — ✅ ALL DONE as of 2026-09-25 (PR #89 merged; close-out done; spike branch preserved on `origin`, evaluate later). Table kept as the 2026-09-05 record:**
