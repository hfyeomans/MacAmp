...
| Current phase | S3 — S3-1 ✅ merged; S3-2 `avplayer-native-video-dsp` 🔧 IN PROGRESS (Phase 8 automated ✅, manual/hardware gates being run by the user from 2026-09-05, Phase 9 next, pushed to origin at `5fe8c3c` but no PR); S3-3 / S3-4 queued |
