...
- **`tasks/done/avplayer-native-video-dsp/`** — new task folder
  ...
  - `todo.md` — ✅ populated 2026-05-02, maintained through Phase 9 — Phases 1-9 checked/dated; post-merge close-out 10.1-10.7 checked, 10.3 (spike-branch deletion) pending the user's decision, 10.8 = the close-out commit
