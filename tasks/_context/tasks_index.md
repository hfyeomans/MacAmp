...
| `stream-track-counter` | Stream elapsed timer + playlist position + auto-play fix + crash guard | Medium | ✅ COMPLETE — Oracle 8/10. Elapsed timer, "3/15" position, auto-play consolidation, loadAudioFile crash guard. |
