...
struct SkinSprites {
    ...
    static let defaultSprites = SkinSprites(sheets: [
        ...
        "TITLEBAR": [
            ...
            Sprite(name: "MAIN_CLUTTER_BAR_BUTTON_O", x: 304, y: 47, width: 8, height: 8),
            Sprite(name: "MAIN_CLUTTER_BAR_BUTTON_O_SELECTED", x: 304, y: 47, width: 8, height: 8),
            Sprite(name: "MAIN_CLUTTER_BAR_BUTTON_A", x: 312, y: 55, width: 8, height: 7),
            Sprite(name: "MAIN_CLUTTER_BAR_BUTTON_A_SELECTED", x: 312, y: 55, width: 8, height: 7),
            Sprite(name: "MAIN_CLUTTER_BAR_BUTTON_I", x: 320, y: 62, width: 8, height: 7),
            Sprite(name: "MAIN_CLUTTER_BAR_BUTTON_I_SELECTED", x: 320, y: 62, width: 8, height: 7),
            Sprite(name: "MAIN_CLUTTER_BAR_BUTTON_D", x: 328, y: 69, width: 8, height: 8),
            Sprite(name: "MAIN_CLUTTER_BAR_BUTTON_D_SELECTED", x: 328, y: 69, width: 8, height: 8),
            Sprite(name: "MAIN_CLUTTER_BAR_BUTTON_V", x: 336, y: 77, width: 8, height: 7),
